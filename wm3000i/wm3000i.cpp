...
void cWM3000I::ActionHandler(int entryAHS)
{
    ...
    {
        QStringList list;
        list.append(RawValData0->VarList());
        list.append(RawValData1->VarList());
        list.append(RawValDataS->VarList());
        list.append(RawValData2->VarList());
        list.append(RawValData3->VarList());
        mSampleDialog0 = new wmScopeDialog(g_WMView);
        mSampleDialog0->setComboBoxItems(0,list);
        mSampleDialog0->setComboBoxItems(1,list);
        AHS++;
        break;
    }
...
//        mSampleDialog0->setSampleValues(val);
    ...
    case PhaseNodeGetAllData2ndCh:
    {
        ...
        //mSampleDialog0->setSingalProperties(str,1);
