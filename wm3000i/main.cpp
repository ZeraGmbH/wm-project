...
int main(int argc, char *argv[])
{
    ...
    WMOeViewBase *g_WMOeView = new WMOeViewBase(g_WMView, "wm3000i"); // eigenfehleranzeige erzeugen
    ...
    if (bconvent)
        g_WMSCPILogFileView =
                new CLogFileView(QObject::tr("WM1000I SCPI Kommunikation"), 100, g_WMView, "WMSCPILogView", "wm3000i");
    else
        g_WMSCPILogFileView =
                new CLogFileView(QObject::tr("WM3000I SCPI Kommunikation"), 100, g_WMView, "WMSCPILogView", "wm3000i");
    ...
    EN61850monitor *g_ETHMonitor = new EN61850monitor(g_WMView, "wm3000i");
    ...
    QObject::connect(g_WMView,SIGNAL(UIJustageOffsetBerechnungActionActivated()),g_WMDevice,SLOT(JustageOffsetBerechnungSlot()));
    QObject::connect(g_WMView,SIGNAL(UIJustageOffsetVarActionActivated()),g_WMDevice,SLOT(JustageOffsetVarSlot()));
    ...
    QObject::connect((QObject*)g_WMDevice,SIGNAL(OffsetValue(double)),wm3000DeviceServer,SLOT(ReceiveOffsetNXResult(double))); // rückgabe des offset wertes an interface
